...
createChatNotification = function(user,projetid,auth,de) {
    var projet = Test.findOne(projetid);
    console.log(user)
    console.log(projet.createurProjet)
    console.log("aaaaaaaaaaaaa")
    if (user !== projet.createurProjet) {
        Notifications.insert({
            userId: projet.createurProjet,
            projetId: projet._id,
            chatId: de,
            notifierName: auth,
            sujet : "t'a envoyé un message",
            read: false
        });
    }
};
