            ...
            if (result)
            {
             ...
             //   console.log(id)
               ...
               // console.log(xxx)
                ...
                contribution={}
                contribution.Idcontributeur=CurrentUserId;
                contribution.IdProjet=idp._id;
                var cont=Contributeur.findOne({Idcontributeur:CurrentUserId})
                if(cont.Idcontributeur!=CurrentUserId) {
                    Contributeur.insert(contribution)
                }
               // if(idp.idcontributeur!=CurrentUserId)
               // {
                //    Test.update({ _id: idp._id },{ $push: { idcontributeur: CurrentUserId}})
               // }
